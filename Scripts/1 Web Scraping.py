...
def webscraping_running_peru(output_name,url,path_chromedriver):
    ...
    Function for webscraping the results of running race in the page 
    ...
    Returns
    -------
    A CSV with the data of a running race.

    '''

    # Set scraping
    web = url # URl with the race running results
    path = path_chromedriver #introduce your file's path inside '...'
    ...
    output_name = pd.DataFrame(dic)  
    output_name.to_csv('output_name.csv')


#links
2017
https://pacifictiming.com/result-wizard/?prefix=170521_lima42k

2018
https://pacifictiming.com/result-wizard/?prefix=180520_lima42k

2019
https://pacifictiming.com/result-wizard/?prefix=190519_lima42k


https://pacifictiming.com/result-wizard/?prefix=170219_candelaria